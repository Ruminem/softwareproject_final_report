...
public class RequestTaskBidHistoryList extends AsyncTask<String, String, String> {

    @SuppressLint("StaticFieldLeak")
    private FragmentMainActivityBulletinView activity;
    final String target     = "http://pssin1.cafe24.com/bulletinBoard/getBidHistoryList.php";
    ...
    RequestTaskBidHistoryList(FragmentMainActivityBulletinView context){
    ...
    protected String doInBackground(String... params) {
        ...
        //while(isRunning) {
            try {
                ...
                query.append("bulletinNumber").append("=").append(bulletinNumber);
...
//                Thread.sleep(5000);
    ...
    public void onPostExecute(String result){
        ...
        activity.getBidHistoryList(this.result);
    }
