...
public class NormalMemberImfomationChangeActivity extends AppCompatActivity {

    TextView idText, phoneText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_member_imfomation_change);
        ...
        Changebtn.setOnClickListener(v -> {
            if(pwText.getText().toString().replace(" ", "").equals("")
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(
                        NormalMemberImfomationChangeActivity.this);
